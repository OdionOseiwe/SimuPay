...
function GrowWithSimu() {
  ...
  return (
    <section id="Growth" className='text-center my-20'>
      <h1 className='text-4xl font-bold mb-5'>Grow with SimuPay</h1>
      ...
      <div className='grid lg:grid-cols-3 gap-10 md:grid-cols-2 grid-cols-1 mx-20'>
        {
            growths.map((grow, index)=>(
